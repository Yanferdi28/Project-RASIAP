...
class ArsipInaktifImporter extends Importer
{
    ...
    public function resolveRecord(): ArsipInaktif
    {
        return new ArsipInaktif();
    }

    public static function getCompletedNotificationBody(Import $import): string
    {
        $body = 'Your arsip inaktif import has completed and ' . Number::format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
